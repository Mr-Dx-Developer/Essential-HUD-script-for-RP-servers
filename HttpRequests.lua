...
PerformHttpRequest("https://raw.githubusercontent.com/ChonkyBadger/BadgerEssentials-v2/master/data.json", function(err, rawData, headers)
    ...
    if curVer == latestVerAsNum then
        print ("^4[Mr_Dx#0] ^3is fully up to date, version ^1" .. latestVerAsNum)
    else
        print ("^4[Mr_Dx#0] ^3is outdated. Version is ^1" .. curVer .. " ^3and the latest available version is ^1" .. latestVerAsNum)
        print ("^4[Mr_Dx#0] ^3You can download the latest version at ^1https://github.com/Mr-Dx-Developer")
